...
def test_move_north_and_south_and_invalid_cases(robot):
    robot.move()
    state = robot.state()
    assert state['row'] == 9
    assert state['col'] == 1
...
def test_move_east_and_invalid(robot):
    robot.turn()
    robot.move()
    state = robot.state()
    assert state['row'] == 10
...
def test_move_west_and_west_invalid(robot):
    robot.turn()
    robot.move()
    robot.turn()
    robot.turn()
...
def test_back_track_once_after_multi_move(robot):
    robot.move()
    robot.move()
    robot.move()
    robot.back_track()
...
def test_back_track_multi_time_after_multi_move(robot):
    robot.move()
    robot.move()
    robot.move()
    robot.back_track()
